...
WundsurfGuide is a package that provides windsurfing recommendations based on wind forecast data,
the users bodyweight, sail size, and skill level. For usage is also needed the city name and
the direction in which the coast is facing in degrees.

# Features

- it retrieves hourly foercast data and thus provides hourly recommendations.
...
Parts of this project are based on code from the WeatherReport.jl package,
...
The guidelines are based on recommendations found on "https://www.windcraftsurf.com/en/blog/beginners-guide-to-windsurfing"
and "https://www.windup.live/blog/wind-speed-for-windsurfing/".
